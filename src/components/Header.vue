...
export default {
  ...
  watch: {
   async searchText(text) {
      console.log(text)
       ...
       const res = await fetch(`https://shop-review-kh-2022.herokuapp.com/store/all?name=${text}`, {
        method: 'GET',
        credentials: 'include',
        headers: {
  ...
  methods: {
    menuToggle() {
     ...
     async onLogout() {
      console.log('test')
      const res = await fetch('https://shop-review-kh-2022.herokuapp.com/auth/logout', {
        method: 'POST',
        credentials: 'include',
        headers: {
          "Content-type": "application/json",
    ...
    async getFavorite(){
      ...
      const get_favorites = await fetch(`https://shop-review-kh-2022.herokuapp.com/favorite/all?user_id=${userData._id}`, {
        method: 'GET',
        credentials: 'include',
        headers: {
          'Content-type': 'application/json',
