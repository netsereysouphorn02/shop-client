...
export default {
  ...
  methods: {
    async deleteItem(feed){
      ...
      const res = await fetch('https://shop-review-kh-2022.herokuapp.com/feedback/delete', {
      method: 'DELETE',
      credentials: 'include',
      headers: {
    ...
    async getFeed(){
      const res = await fetch('https://shop-review-kh-2022.herokuapp.com/feedback/all', {
            method: 'GET',
            credentials: 'include',
            headers: {
              'Content-type': 'application/json',
