...
export default {
  ...
  methods: {
    async getPosts() {
      const res = await fetch('https://shop-review-kh-2022.herokuapp.com/post/all', {
        method: 'GET',
        credentials: 'include',
        headers: {
    ...
    async post(e) {
      ...
      //get user
      const user = await fetch('https://shop-review-kh-2022.herokuapp.com/auth/me', {
        method: 'GET',
        credentials: 'include',
        headers: {
          'Content-type': 'application/json',
      ...
      //https://shop-review-kh-2022.herokuapp.com/post/create
      const post_create = await fetch('https://shop-review-kh-2022.herokuapp.com/post/create', {
        method: 'POST',
        credentials: 'include',
        headers: {
          'Content-type': 'application/json',
  ...
  async created() {
    const res = await fetch('https://shop-review-kh-2022.herokuapp.com/auth/me', {
      method: 'GET',
      credentials: 'include',
      headers: {
        'Content-type': 'application/json',
