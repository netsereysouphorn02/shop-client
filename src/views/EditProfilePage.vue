...
export default {
  ...
  methods: {
    ...
    async updatePasswordUser() {
      this.message = false
      const res = await fetch('https://shop-review-kh-2022.herokuapp.com/user/update-password', {
        method: 'POST',
        credentials: 'include',
        headers: {
    ...
    async updateUser() {
      ...
      const res = await fetch('https://shop-review-kh-2022.herokuapp.com/user/update', {
        method: 'POST',
        credentials: 'include',
        headers: {
          'Content-type': 'application/json',
