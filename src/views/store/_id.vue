...
export default {
  ...
  methods: {
    ...
    async subReview() {
      ...
      const res = await fetch(`https://shop-review-kh-2022.herokuapp.com/review/create`, {
        method: "POST",
        credentials: "include",
        headers: {
    ...
    async getReview() {
      const res = await fetch(
        `https://shop-review-kh-2022.herokuapp.com/review/all?storeId=${this.id}`,
        {
          method: "GET",
          credentials: "include",
          headers: {
    ...
    async favorite(store_id) {
      ...
      //add to favorite
       const addFav = await fetch('https://shop-review-kh-2022.herokuapp.com/favorite/create', {
        method: 'POST',
        credentials: 'include',
        headers: {
          "Content-type": "application/json",
  ...
  async created() {
    ...
    const res = await fetch(`https://shop-review-kh-2022.herokuapp.com/store/id/${id}`, {
      method: "GET",
      credentials: "include",
      headers: {
        "Content-type": "application/json",
